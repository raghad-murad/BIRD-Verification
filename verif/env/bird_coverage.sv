...
class bird_coverage extends uvm_subscriber #(bird_transaction);
    ...
    covergroup cg_payload_len;
        ...
        cp_len: coverpoint current_pkt.payload_len {
            ...
            // Unreachable due to monitor constraints
            ...
            // Unreachable due to invalid payload allocation
    ...
    // Snapshot values for backpressure coverage
    ...
    covergroup cg_backpressure;
        ...
        // DUT hard-wires in_rdy=1, so input can never stall; only no_backpressure is reachable
    ...
    covergroup cg_cross;
        ...
        // Ignore illegal local multi-fragment combinations
    ...
    // Sample transaction-based coverage
